...
//  Hitboxes
set_move_num_hitboxes(AT_DTILT, 3);
...
set_move_hitbox_property(AT_DTILT, 3, HG_LIFETIME, [ 6,  4,  9,  4]);
...
set_hitbox_value(AT_DTILT, 3, HG_LIFETIME, get_move_hitbox_property(AT_DTILT, 3, HG_LIFETIME, stance));
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 13);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -15);
set_hitbox_value(AT_DTILT, 3, HG_WIDTH, 58);
set_hitbox_value(AT_DTILT, 3, HG_HEIGHT, 33);
set_hitbox_value(AT_DTILT, 3, HG_SHAPE, 2);
set_hitbox_value(AT_DTILT, 3, HG_PRIORITY, 2);
set_hitbox_value(AT_DTILT, 3, HG_DAMAGE, 2);
set_hitbox_value(AT_DTILT, 3, HG_ANGLE, 125);
...
set_hitbox_value(AT_DTILT, 3, HG_HITPAUSE_SCALING, 0.35);
...
set_hitbox_value(AT_DTILT, 3, HG_HIT_PARTICLE_NUM, 0);
set_hitbox_value(AT_DTILT, 3, HG_HIT_SFX, 499);
