...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX_FRAME, 6);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_CUSTOM_GRAVITY, water_gravity_speed);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 102);
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 102);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -67);
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 98.00);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 91.83);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -47);
set_hitbox_value(AT_USPECIAL, 4, HG_WIDTH, 104);
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 116);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITPAUSE_SCALING, 0.85);
