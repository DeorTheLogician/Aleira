...
set_move_hitbox_property(AT_NAIR, 1, HG_WIDTH, [118,118, 118, 118]);
set_move_hitbox_property(AT_NAIR, 1, HG_HEIGHT, [58, 62, 58, 58]);
...
set_move_hitbox_property(AT_NAIR, 2, HG_HITBOX_X, [-8,-4,-8,-8]);
set_move_hitbox_property(AT_NAIR, 2, HG_HITBOX_Y, [-56,-32,-56,-56]);
set_move_hitbox_property(AT_NAIR, 2, HG_WIDTH, [54,118, 54, 54]);
set_move_hitbox_property(AT_NAIR, 2, HG_HEIGHT, [42, 62, 42, 42]);
set_move_hitbox_property(AT_NAIR, 2, HG_SHAPE, [ 0,  2,  0,  0]);
set_move_hitbox_property(AT_NAIR, 2, HG_DAMAGE, [ 5,  4,  5,  7]);
set_move_hitbox_property(AT_NAIR, 2, HG_ANGLE, [70, 55, 70,  75]);
set_move_hitbox_property(AT_NAIR, 2, HG_BASE_KNOCKBACK, [ 5,  6,  3,  5]);
set_move_hitbox_property(AT_NAIR, 2, HG_KNOCKBACK_SCALING, [.5,  .5, .5, .5]);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, move_data[AT_NAIR].hitboxes[2][HG_HITBOX_X][stance]);
